...
function getTagList() {
    ...
    for (let i = 0; i < database.tagList.length; i++) {
        ...
        for (let i = 0;
            (database.tagList[taglevel1].children != null) && (i < database.tagList[taglevel1].children.length); i++) {
            let taglevel2 = i;
            ...
            for (let i = 0;
                (database.tagList[taglevel1].children[taglevel2].children != null) && (i < database.tagList[taglevel1].children[taglevel2].children.length); i++) {
                let taglevel3 = i;
...
function getMasterList() {
    ...
    for (let i = 0; i < database.tagList.length; i++) {
        ...
        for (let i = 0;
            (database.tagList[level1].children != null) && (i < database.tagList[level1].children.length); i++) {
            let level2 = i;
            ...
            for (let i = 0;
                (database.tagList[level1].children[level2].children != null) && (i < database.tagList[level1].children[level2].children.length); i++) {
                let level3 = i;
